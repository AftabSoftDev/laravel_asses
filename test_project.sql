...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2528368020ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test_project&table=users">`test_project`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test_project&table=company">`test_project`.`company`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test_project&table=migrations">`test_project`.`migrations`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test_project&table=personal_access_tokens">`test_project`.`personal_access_tokens`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel&table=company">`laravel`.`company`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=empprojects&table=employees">`empprojects`.`employees`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gainaloe&table=users">`gainaloe`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gainaloe&table=products">`gainaloe`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=digi_cpr&table=patient_reg">`digi_cpr`.`patient_reg`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel&table=table">`laravel`.`table`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="test_project" targettable="company">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `company`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="test_project" targettable="personal_access_tokens">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `company`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="test_project" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="test_project" targettable="migrations">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            targetdb="test_project" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">DROP TABLE `company`, `migrations`, `personal_access_tokens`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test_project" targettable="users">
                            <div class="action_content">
